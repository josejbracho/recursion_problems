...
advancedExponent(2, 0); // 1  ---- 2^(0/2) => 1^2 = 1 ---- Call it once
advancedExponent(2, 1); // 2  ---- 2^(1-1/2) => 1^2 * 2 = 2 ---- Call it once
advancedExponent(2, 2); // 4  ---- 2^(2/2) => 2^2 = 4 ---- Call it once
advancedExponent(2, 3); // 8  ---- 2^(3-1/2) => 2^2 * 2 = 8 ---- Call it once
advancedExponent(2, 4); // 16 ---- 2^(4/2) => 4^2 = 16 ---- Call it twice
advancedExponent(2, 5); // 32 ---- 2^(5-1/2) => 4^2 * 2 = 32 ---- Call it twice
advancedExponent(2, 6); // 64 ---- 2^(6/2) => 8^2 = 64 ---- Call it three times
advancedExponent(2, 7); // 128 ---- 2^(7-1/2) => 8^2 *2 = 128 ---- Call it three times
advancedExponent(2, 8); // 256 ---- 2^(8/2) => 16^2 = 256 ---- Call it four times
...
times `advancedExponent` is being recursively called. (is called n / 2 times)
***********************************************************************/
